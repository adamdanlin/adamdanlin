...
class VRButton{
    ...
    stylizeElement(element, active = true, fontSize = 13, ignorePadding = false) {
        ...
        element.style.borderRadius = '50%'; // Example: make it circular
        element.style.background = (active) ? 'rgba(0, 128, 0, 1)' : 'rgba(255, 0, 0, 1)'; // Change background color
        element.style.color = '#fff'; // Change text color
